...
def middle_number(numbers):
    """
    Получает список чисел, либо False при неверных введенных данных и возвращает медианное значение из списка чисел.

    :param numbers: list of numbers or bool False при неверных введенных значениях
    """
    if numbers == False:
